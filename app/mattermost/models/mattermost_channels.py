...
class MattermostChannelModel(Base):
    ...
    document_channel = relationship("MattermostDocumentModel", primaryjoin="MattermostChannelModel.id==MattermostDocumentModel.channel")
    team_channel_pairs = UniqueConstraint('team_name', 'channel_name', name='team_channel_pairs')
