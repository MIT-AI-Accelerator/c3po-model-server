...
class Batch(object):
    ...
    #changed lines 27-28, 34, 37, 46-47, 50, 52
    def __init__(self, data=None, device=None,  is_test=False):
        ...
        if data is not None:
            ...
            idxs = [x[-2] for x in data] #index 6 if test, index 4 if train #reintroduced
            fns = [x[-1] for x in data] #index 6 if test, index 4 if train
...
class DataIterator(object):
    ...
    def preprocess(self, ex, is_test):
        ...
        fn = ex['fn']
        #new, for regression:
        idxs = ex['idxs'] #reintroduced

        if(is_test):
            return src,labels,segs, clss, src_txt, tgt_txt, idxs, fn
        else:
            return src,labels,segs, clss, fn
