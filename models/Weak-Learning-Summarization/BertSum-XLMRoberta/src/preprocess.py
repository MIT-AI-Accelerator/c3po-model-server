...
#lines 17-20 were changed
def do_format_to_lines_aiia(args):
    print(time.clock())
    data_builder.format_to_lines_aiia(args)
    print(time.clock())
...
def do_format_to_bert_aiia(args):
    print(time.clock())
    data_builder.format_to_bert_aiia(args)
    print(time.clock())
...
#lines 50, 55 and 71 were changed
if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument("-mode", default='', type=str, help='format_to_lines or format_to_bert or format_to_lines_aiia or format_to_bert_aiia')
    ...
    parser.add_argument("-file_order_path", default='../bert_data_fileorder', help='location to output list of filenames after they have been randomly reordered by BertSum internals')
