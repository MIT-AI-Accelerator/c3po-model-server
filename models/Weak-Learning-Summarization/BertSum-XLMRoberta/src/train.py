...
def validate(args,  device_id, pt, step):
    ...
    config = XLMRobertaConfig.from_json_file(args.bert_config_path)
...
#    trainer.train(train_iter_fct, args.train_steps)
    total_stats = trainer.train(train_iter_fct, args.train_steps)
    return total_stats.xent()
...
if __name__ == '__main__':
    ...
    parser.add_argument("-bert_config_path", default='../xlmroberta_config_uncased_base.json')
